...
while True:
    ...
    if ((((check_color(red_pts,red)or check_color(red_pts,blue))and(check_dis(red_pts)!=True))or check_color(blue_pts,blue))and fire(im)):
        if flag==0:
            ...
            for i in range(177):
                #'''
                #if tell_color_dis(im.getpixel((354+i,477)),(222 ,48 ,189),132.92855223765886 ):

                if (tell_color_dis(im.getpixel((354+i,477)),(222 ,48 ,189),132.92855223765886 )and
                    inthis(white[0],white[1],im.getpixel((354+i+11,477)))and
                    wc(im,white,354+i+11,477)and flag==0):
                    direction=''
                    f=1
                    wind=1
                    if ( wc2(im,white,354+i,461)and
                         wc2(im,white,354+i,493)) :
                        direction='right'
                    else:
                        direction='left'
                    g=354+i
