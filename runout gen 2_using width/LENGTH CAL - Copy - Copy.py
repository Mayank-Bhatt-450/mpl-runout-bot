...
def lengths(im):
    ...
    j=0
    for i in range(79):
        if tell_color_dis(im.getpixel((p+i,445)),[0,0,0],25.495097567963924):
            j=p+i
            break
    num=0
    k=0
    ...
    while (445-k)>=0:
        ...
        if tell_color_dis(im.getpixel((j,445-k)),[0,0,0]):
            k0=0
            nb_val_pt=0
            #print('\n(1)',(j,445-k),k)
            hight+=1
