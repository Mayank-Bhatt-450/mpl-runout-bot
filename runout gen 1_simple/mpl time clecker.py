...
while True:
    ...
    white=[[255, 255, 255], [220, 183, 219]]#[(255,255,255),(200,200,200)]
    ...
    if ((inthis(red[0],red[1],k[0]or inthis(red[0],red[1],k[1])or inthis(red[0],red[1],k[2]))or inthis(red[0],red[1],k[3])or inthis(red[0],red[1],k[4])or inthis(red[0],red[1],k[5]))
        ...
        for i in range(158):
            ...
            if (inthis(pink[0],pink[1],im.getpixel((650+i,298)))and inthis(white[0],white[1],im.getpixel((650+i+7,298)))and flag==0):
                k=''
                f=1
                wind=1
