    ...
    if (((check_color(k,red)or check_color(k,blue))and(check_dis(k)!=True))or check_color(blue_pts,blue)):
        ...
        if direction=='':
            ...
            if direction=='left':
                ...
                pyautogui.moveTo(720,719)
                if f==3:
                    pyautogui.dragTo(720,332,duration=0.2)#pyautogui.dragTo(720+(wind_angle),332,duration=0.2)
                else:
                    pyautogui.dragTo(720,332,duration=0.2)#pyautogui.dragTo(720+(8*f),332,duration=0.2)
            else:
