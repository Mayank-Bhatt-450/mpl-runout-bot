    ...
    if (((check_color(k,red)or check_color(k,blue))and(check_dis(k)!=True))or check_color(blue_pts,blue)):
        ...
        if direction=='':
            ...
            if direction=='left':
                pyautogui.moveTo(720,719)
                if f==3:
                    if width>=10 and width<=12:
                        pyautogui.dragTo(720+(wind_angle+2),332,duration=0.2)
                    elif width>=13 and width<14:
                        pyautogui.dragTo(720+(wind_angle)+2,332,duration=0.2)
                    elif width>=14 and width<15:
                        pyautogui.dragTo(720+(wind_angle)+2,332,duration=0.2)
                    elif width>=15 and width<16:
                        pyautogui.dragTo(720+(wind_angle)+1,332,duration=0.2)
                    elif width>=16 and width<17:#pivit
                        pyautogui.dragTo(720+(wind_angle)-1,332,duration=0.2)
                        ...
                        pyautogui.dragTo(720+(wind_angle)-1,332,duration=0.2)
                    elif width>=20 and width<23:
                        pyautogui.dragTo(720+(wind_angle)-1,332,duration=0.2)
                    elif width>=23 and width<27:#pivit
                        pyautogui.dragTo(720+(wind_angle-2),332,duration=0.2)
                    elif width>=27 and width<33:
                        pyautogui.dragTo(720+(wind_angle-2),332,duration=0.2)
                    elif width>=33 and width<=40:
                        pyautogui.dragTo(720+(wind_angle-3),332,duration=0.2)
                    else:
                ...
                if f==3:
                    if width>=10 and width<=12:
                        ...
                        pyautogui.dragTo(720-(wind_angle)+2,332,duration=0.2)
                    elif width>=17 and width<18:#perfect 
                        pyautogui.dragTo(720-(wind_angle-1),332,duration=0.2)
                    elif width>=18 and width<19:
                        pyautogui.dragTo(720-(wind_angle-1),332,duration=0.2)
                    elif width>=19 and width<20:
                        pyautogui.dragTo(720+(wind_angle)-1,332,duration=0.2)
                    elif width>=20 and width<22:
                        pyautogui.dragTo(720-(wind_angle)-1,332,duration=0.2)
                    elif width>=22 and width<23:
                        pyautogui.dragTo(720-(wind_angle)-2,332,duration=0.2)
                    elif width>=23 and width<24:#pivit
                        pyautogui.dragTo(720-(wind_angle-2),332,duration=0.2)
                    elif width>=24 and width<25:#pivit
                        pyautogui.dragTo(720-(wind_angle-2),332,duration=0.2)
                    elif width>=25 and width<26:#pivit
                        pyautogui.dragTo(720-(wind_angle-2),332,duration=0.2)
                    elif width>=26 and width<27:#pivit
                        pyautogui.dragTo(720-(wind_angle-2),332,duration=0.2)
                    elif width>=27 and width<33:
                        pyautogui.dragTo(720-(wind_angle-2),332,duration=0.2)
                    elif width>=33 and width<=40:
