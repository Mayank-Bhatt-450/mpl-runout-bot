...
while True:
    ...
    red_pts=[im.getpixel((668,696)),#0
       ...
       im.getpixel((447,1067)),#2
       im.getpixel((389,1094)),#3
       im.getpixel((533,1113)),#4
       im.getpixel((450,1104)),#5#prob
       im.getpixel((394,1179)),#6
       im.getpixel((450,1150)),
       im.getpixel((516,1187)),]#7
    
    blue_pts=[im.getpixel((481,1015)),
              im.getpixel((447,1059)),
              im.getpixel((544,1112)),
              im.getpixel((375,1190)),
              im.getpixel((362,1233)),
              im.getpixel((528,1238)),
              im.getpixel((543,1265)),
              im.getpixel((452,1281)),
              im.getpixel((426,1308))]
    ...
    if ((((check_color(red_pts,red)or check_color(red_pts,blue))and(check_dis(red_pts)!=True))or check_color(blue_pts,blue))and fire(im)):
        if flag==0:
            ...
            for i in range(177):
                if (inthis(pink[0],pink[1],im.getpixel((535-i,447)))and
                    inthis(white[0],white[1],im.getpixel((535-i-10,447)))and
                    wc(im,white,(535-i-10,447))and flag==0):
                    ui=im.getpixel((663+i,298))
                    direction=''
                    f=1
                    wind=1
                    print( wc2(im,white,663+i,288), wc2(im,white,663+i,308))
        ...
        if direction=='':
            ...
            pyautogui.dragTo(center,0,duration=0.2)
        else:
            ...
            if direction=='left':
                pyautogui.moveTo(720,719)
                if f==3:
                    pyautogui.dragTo(720+angle,0,duration=0.2)
                elif f==2:
                    pyautogui.dragTo(720+(wind2),0,duration=0.2)
                elif f==1:
                    pyautogui.dragTo(720+(wind1),0,duration=0.2)
            else:
