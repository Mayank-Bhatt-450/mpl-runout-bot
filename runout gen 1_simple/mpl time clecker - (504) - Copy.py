    ...
    if ((inthis(red[0],red[1],k[0]or inthis(red[0],red[1],k[1])or inthis(red[0],red[1],k[2]))or inthis(red[0],red[1],k[3])or inthis(red[0],red[1],k[4])or inthis(red[0],red[1],k[5]))
        ...
        for i in range(107):
            ...
            if (inthis(pink[0],pink[1],im.getpixel((663+i,298)))and inthis(white[0],white[1],im.getpixel((663+i+7,298)))and flag==0):
                ...
                f=1
                wind=1
                if ( wc2(im,white,663+i,288)) :#and inthis2(white[0],white[1],im.getpixel((663+i,288))))
                    ...
                    direction='left'
                g=663+i+7
                if wc(im,white,g+25,297):#inthis(white[0],white[1],im.getpixel((g+25,297)))):
                    f+=1
                    if wc(im,white,g+46,297):#inthis(white[0],white[1],im.getpixel((g+46,297)))):
                        f+=1
